...
const stats = [
  {
    icon: BookOpen,
    number: "5000+",
    // Substituímos "Trabalhos Entregues" por "Projetos Orientados" para
    // comunicar que nosso foco está em mentoria e apoio, não na entrega de
    // trabalhos prontos.
      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
            ...
            suas ideias em projetos de qualidade por meio de orientação, estudo e revisão.
          </p>
        </div>
        ...
        <div className="mt-24 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 flex justify-center">
            <img
              ...
              alt="Sistema Anti-plágio CopySpider - Celular e Notebook"
