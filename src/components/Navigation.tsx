...
import { Menu, X } from "lucide-react"; // BookOpen removido
      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <span
              className={`text-xl font-playfair font-bold transition-colors ${
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button
              ...
              className={
                !isScrolled
                  ? "bg-primary-foreground/10 backdrop-blur-sm border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/20"
                  : ""
              }
